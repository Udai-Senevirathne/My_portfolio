...
// Import SafeCom images
import safecomMain from '../assets/Safecom1.png';
import safecomLandscape from '../assets/Safecom2.png';
import safecomLeft from '../assets/SafeCom3.png';
import safecomPortrait from '../assets/SafeCom4.png';
import newImage1 from '../assets/Safecm5.png'; 
import newImage2 from '../assets/SafeCom6.png'; 
...
const Projects = () => {
  const featuredProject = {
    ...
    images: [safecomMain, safecomPortrait, safecomLandscape, safecomLeft,newImage1, newImage2],
    ...
    <div className="absolute inset-0 z-0">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          {/* Project details box */}
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg overflow-hidden border border-gray-700 hover:border-teal-400 transition-all duration-300 hover-lift max-w-4xl mx-auto">
